...
def generate_launch_description():
    ...
    world_file_path = 'gazebo_worlds/obs_world.world'
    ...
    robot_name_in_model = 'tortilla_mecanica'

    # Get URDF via xacro

    urdf_file_name = 'NuevaBaseMetal3.urdf'
    urdf = os.path.join(
        get_package_share_directory('octobot_2'),
        'urdf',
        urdf_file_name
        )
